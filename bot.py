...
EDGY_JOKES = [
    ...
    "Сподіваюся, ти теж так дбаєш про власне здоров'я, як про цю свиню...",
...
FAIL_MESSAGES = [
    ...
    "Капібарка вирішила продати частину душі. Хто ж знав що вона теж має вагу?",
...
EQUILIBRIUM_MESSAGES = [
    ...
    "Капібарка змерзла і вийшла в нуль, спаливши калорії"
]
...
async def delete_kapy(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_id in kapyland_db:
        ...
        save_data(kapyland_db)
        await update.message.reply_text("❌ Твоя капібара пішла навіки купатися в теплі джерела. Тепер ти зовсім один.")
    else:
